...
export const projectList: Projects = [
    {
      ...
      desc: 'A SPA dedicated to NBA fans showing latest news, scores, info about teams and players. Uses Angular Material, services and RxJs operators to elaborate data received from remote 3rd party API.',
    ...
    },
    {
      ...
      imgSrc: './assets/img/ecom.jpg',
      desc: 'I started this project to have a taste of React and its main features. The store features a catalogue of products, search, cart and filtering options.',
      designUrl: null,
      gitUrl: 'https://github.com/franckyi/react-ecommerce',
      liveUrl: 'https://react-ecommerce.francky.works/',
    },
    {
    ...
    },
    {
      title: 'Calculator',
      subtitle: 'JavaScript',
      imgSrc: './assets/img/calc.jpg',
      desc: 'Practiced JavaScript language and DOM manipulation with doing this project. Maked it more children-friendly to share it with my little sister :)',
      designUrl: null,
      gitUrl: 'https://github.com/franckyi/calculator',
      liveUrl: 'https://franckyi.github.io/calculator/',
    },
    {
      title: 'Lantu Website',
