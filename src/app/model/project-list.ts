...
export const projectList: Projects = [
    {
      ...
      desc: 'The final project of the SDA JavaScript bootcamp. An SPA dedicated to NBA fans, showing latest news, scores, info about teams, players and search forms for further filtering of info. Uses Material, services, RxJs operators to elaborate data received from remote APIs. I\'m continuously improving it.',
